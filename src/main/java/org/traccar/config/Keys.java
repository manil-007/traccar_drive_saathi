...
public final class Keys {
        ...
        /**
         * Network interface for the protocol. If not specified, server will bind all
         * interfaces.
         */
        ...
        /**
         * If not zero, enable buffering of incoming data to handle ordering locations.
         * The value is threshold for
        ...
        /**
         * Number of Netty boss threads. If not specified or zero, Netty default value
         * is used.
         */
        ...
        /**
         * Number of Netty worker threads. If not specified or zero, Netty default value
         * is used.
         */
        ...
        /**
         * Speed limit threshold multiplier. For example, if the speed limit is 100, but
         * we only want to generate an event
         * if the speed is higher than 105, this parameter can be set to 1.05. Default
         * multiplier is 1.0.
         */
        ...
        /**
         * Server attribute that indicates that TOTP authentication is required for new
         * users.
         */
        ...
        /**
         * Command sender type for the device. This overrides standard data or text
         * commands with an API-based commands.
        ...
        /**
         * If the event time is too old, we should not send notifications. This
         * parameter is the threshold value in
        ...
        /**
         * Block notifications for specific users. The value should be a comma-separated
         * list of internal user ids.
         */
        ...
        /**
         * Time threshold for fast reports. Fast reports are more efficient, but less
         * accurate and missing some information.
        ...
        /**
         * APISETU base URL. Default is sandbox. For production use set to
         * https://apisetu.gov.in/
         */
        public static final ConfigKey<String> APISETU_BASE_URL = new StringConfigKey(
                        "apisetu.baseUrl",
                        List.of(KeyType.CONFIG),
                        "https://sandbox.api-setu.in/");

        /**
         * APISETU API key. Default is sandbox demo key.
         */
        public static final ConfigKey<String> APISETU_API_KEY = new StringConfigKey(
                        "apisetu.apiKey",
                        List.of(KeyType.CONFIG),
                        "demokey123456ABCD789");

        /**
         * APISETU client id. Default is sandbox demo client id.
         */
        public static final ConfigKey<String> APISETU_CLIENT_ID = new StringConfigKey(
                        "apisetu.clientId",
                        List.of(KeyType.CONFIG),
                        "in.gov.sandbox");
        ...
        /**
         * Provider to use for LBS location. Available options: google, unwired and
         * opencellid. By default, google is
        ...
        /**
         * ORS (OpenRouteService) API key. Default is the debug/sandbox key used in
         * development/debug.xml. Can be overridden via environment or config file.
         */
        public static final ConfigKey<String> ORS_API_KEY = new StringConfigKey(
                        "ors.apiKey",
                        List.of(KeyType.CONFIG));

        /**
         * Ola Maps API key. Prefer configuring this via debug.xml or env using
         * 'ola.maps.apiKey'. Fallbacks are handled in resource code.
         */
        public static final ConfigKey<String> OLA_MAPS_API_KEY = new StringConfigKey(
                        "ola.maps.apiKey",
                        List.of(KeyType.CONFIG));
        ...
        /**
         * Process geolocation only when Wi-Fi information is available. This makes the
        ...
        /**
         * If this parameter is set, Traccar will monitor drops in the number of stored
         * messages. If it drops more than
         * the threshold, it will mark service as failing for systemd. Threshold is a
         * value from 0.0 to 1.0. For example,
         * value 0.7 means that the number of messages in the last period is only 70% of
        ...
        /**
         * If all bytes are printable characters, log network data as text instead of
         * HEX.
         */
        ...
        /**
         * Broadcast method. Available options are "multicast" and "redis". By default,
         * (if the value is not
        ...
        /**
         * Flag to mark secondary servers. Some tasks, like scheduled reports, will be
         * executed on the main server only.
         */
