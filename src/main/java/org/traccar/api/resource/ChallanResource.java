...
public class ChallanResource {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(ChallanResource.class);

    private static final String APISETU_PATH = "certificate/v3/transport/chaln";
    ...
    public Response verify(@jakarta.ws.rs.core.Context jakarta.servlet.http.HttpServletRequest servletRequest) {
        try {
            ...
            LOGGER.warn("Challan verify failed: {}", e.getMessage());
            return Response.status(Response.Status.INTERNAL_SERVER_ERROR)
